...
This repository holds the arc.conf and slurm configuration files for the ARC SLURM test-site. The endpoint fqdn is:  arctestcluster2-hackathon-slurm-el7-ce1.cern-test.uiocloud.no
